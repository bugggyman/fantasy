...
champs = [["Сhampions League", "http://sports.williamhill.com/bet/en-gb/betting/t/344/UEFA+Champions+League.html", "http://www.oddsportal.com/soccer/europe/champions-league/"], 
["Europa League", "http://sports.williamhill.com/bet/en-gb/betting/t/1935/UEFA+Europa+League.html", "http://www.oddsportal.com/soccer/europe/europa-league/"]]
...
browser.set_window_size(1300, 900) # PhantomJS default to 400X300 is executable element outside might cause problem
...
for key in sorted(ALLTHEDAMNPLAYERS):
    ...
    if not valuesExist:
        ...
        newDict[key] = [value[0],value[1],value[2],updated_value,value[4]]
...
for key in sorted(newDict):
    ...
    if not valuesExist:
        ...
        newDict1[key] = [value[0],value[1],value[2],updated_value,value[4]]

with open('Koeffs.csv', 'w', newline='', encoding='utf-16') as csv_file:
    writer = csv.writer(csv_file)
    writer.writerow([u"ID", u"Команда",u"Чемпионат",u"Соперник1",u"Тип",u"Кэф"])
